...
\begin{figure}[h]
\begin{tabular}{c}
\subfloat[frame = 1]{\includegraphics[width = 2.5in]{Skiing-CustomBB-0001}} \\
\subfloat[frame = 31]{\includegraphics[width = 2.5in]{Skiing-CustomBB-0031}} \\
\subfloat[frame = 32]{\includegraphics[width = 2.5in]{Skiing-CustomBB-0032}} \\
\end{tabular}
\centering
\caption{A video tracking sequence where the initial bounding box was increased in size to account for the object growing throughout the sequence. Notice that by frame 32, the majority of the object remains in the bounding box, allowing for much more accurate tracking than in Figure~\ref{fig:scaling2}.}
\label{fig:scaling3}
\end{figure}
...
Some of these results are shown in the figures below and even more can  be seen on our GitHub page at \verb!https://github.com/msu-ml/16spr_cao_gonzales_hoffman/tree/master/results!.
...
\begin{figure}[h]
\begin{tabular}{c}
\subfloat[frame = 1]{\includegraphics[width = 2.5in]{Basketball-0001}} \\
\subfloat[frame = 107]{\includegraphics[width = 2.5in]{Basketball-0107}} \\
\subfloat[frame = 624]{\includegraphics[width = 2.5in]{Basketball-0624}} \\
\end{tabular}
\centering
\caption{The Basketball video tracking sequence.}
\label{fig:basketball}
\end{figure}

\begin{figure}[h]
\begin{tabular}{c}
\subfloat[frame = 1]{\includegraphics[width = 3.5in]{Matrix-0001}} \\
\subfloat[frame = 23]{\includegraphics[width = 3.5in]{Matrix-0023}} \\
\subfloat[frame = 54]{\includegraphics[width = 3.5in]{Matrix-0054}} \\
\end{tabular}
\centering
\caption{The Matrix video tracking sequence.}
\label{fig:matrix}
\end{figure}
